...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      { title: 'Dashboard', path: PATH_DASHBOARD.general.image, icon: ICONS.file },
      { title: 'Logs', path: PATH_DASHBOARD.general.app, icon: ICONS.blog },
      // { title: 'File Encode & Decode', path: PATH_DASHBOARD.general.file, icon: ICONS.file },
